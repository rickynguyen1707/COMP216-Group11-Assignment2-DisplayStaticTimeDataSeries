...
class DataGenerator(tkk.Tk):
    ...
    def initUI(self):
        ...
        def go():
            ...
            draw_rects(self.data_range.get())

        def draw_rects(data_range):
            ...
            for x, y in enumerate(range):
                ...
                if (x != 0):
                    self.my_canvas.create_line(old_x_coord + line_spacing, old_y2,
        ...
        # Labels
        self.data_range_entrylabel = tkk.Label(self, text="Data range", font=("Ariel", 15),
                                               width=15, bg="white")
        self.data_range_label = tkk.Label(self,
                                          text=f"Data range: {self.data_range.get()}-{self.data_range.get() + 5}",
                                          font=("Ariel", 15), width=30, bg="white")
        ...
        # Button
        self.data_range_button = tkk.Button(self, text="Go", width=20,
